...
// =============================================
    ...
    window.switchAdminTab = (tabName) => {
        ...
        // Mostrar la seleccionada o el placeholder
        ...
        // Actualizar botón activo (visual)
    ...
    // 2. BUSCAR PRODUCTO PARA EDITAR (Input código)
    ...
    // 3. EDITAR SELECCIONADO (Desde tabla)
    window.editSelectedProduct = () => {
        ...
        if(product) {
            switchAdminTab('add'); 
            // Forzar visualmente el cambio de botón activo en menú
            document.querySelectorAll('.menu-btn').forEach(b => b.classList.remove('active'));
            document.querySelectorAll('.menu-btn')[2].classList.add('active'); // Ajusta índice según orden
            loadProductForEdit(product);
        }
    };

    // 4. CARGAR DATOS EN FORMULARIO
    ...
    // Auxiliar: Llenar selects del admin
    ...
    // Recuerda actualizar tu función clearForm para limpiar el ID también
